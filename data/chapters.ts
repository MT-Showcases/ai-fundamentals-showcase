...
export const chapters: Chapter[] = [
  {
    ...
    sections: [
      ...
      { title: "Startup Lens", content: "Per un MVP startup, usa AI dove riduce tempo operativo in modo misurabile: supporto clienti, classificazione ticket, suggerimenti contenuto. Definisci KPI semplici (tempo medio risposta, tasso risoluzione, error rate) prima del rilascio." },
      { title: "Errore comune + Mini esercizio", content: "Errore comune: trattare l'AI come fonte di verita assoluta. Mini esercizio (15 min): prendi 3 risposte AI su un tema tecnico, verifica fonti, segna cosa era corretto, ambiguo o errato, poi riscrivi una risposta validata." },
    ],
    keyTakeaways: [
