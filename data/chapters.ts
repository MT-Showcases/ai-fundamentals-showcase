...
export const chapters: Chapter[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { title: "Errore comune + Check rapido", content: "**Errore comune:** aumentare layer senza una strategia di validazione. **Check rapido (2 min):** guarda il tuo scenario e rispondi: stai scegliendo profondità perché serve davvero ai dati o solo perché sembra più potente?", media: [ { type: 'podcast', title: 'Podcast — Profondità con criterio', description: 'Trade-off pratici tra profondità, costo e robustezza.', placeholderPath: 'media/ch05-neural-networks/sec-04/podcast.mp3', notes: 'placeholder' } ] },
    ],
    keyTakeaways: [
