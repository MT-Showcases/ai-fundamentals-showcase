...
export const ch08: Chapter = {
    ...
    challenge: {
      ...
      fullText: "GPT-3 è stato rilasciato da OpenAI nel 2020 ed è il primo modello di linguaggio mai creato. Il modello utilizza un'architettura chiamata LSTM, sviluppata originalmente per la traduzione automatica. Con i suoi 175 miliardi di parametri, GPT-3 ha dimostrato capacità notevoli su molti benchmark linguistici. La temperatura nei modelli generativi controlla la lunghezza del testo prodotto: valori più alti generano testi più lunghi. Le allucinazioni si verificano perché il modello genera token probabilistici senza accesso a fatti verificati in tempo reale.",
      spans: [
        ...
        { id: 's3', text: " Il modello utilizza un'architettura chiamata LSTM", isError: true, feedback: "❌ Allucinazione! GPT-3 usa l'architettura Transformer, non LSTM. Le LSTM sono reti ricorrenti, superate dai Transformer per i task linguistici." },
        { id: 's4', text: " sviluppata originalmente per la traduzione automatica", isError: false, feedback: "Corretto — il paper 'Attention is All You Need' (2017) introdusse i Transformer proprio per la traduzione automatica." },
        { id: 's5', text: " Con i suoi 175 miliardi di parametri, GPT-3 ha dimostrato capacità notevoli su molti benchmark linguistici", isError: false, feedback: "Corretto — GPT-3 ha 175B parametri e ha ottenuto risultati significativi su diversi benchmark, pur con limitazioni note." },
        { id: 's6', text: " La temperatura nei modelli generativi controlla la lunghezza del testo prodotto: valori più alti generano testi più lunghi", isError: true, feedback: "❌ Allucinazione! La temperatura controlla la casualità/creatività, NON la lunghezza. Valori alti = output più imprevedibile, valori bassi = più deterministico e ripetitivo." },
        { id: 's7', text: " Le allucinazioni si verificano perché il modello genera token probabilistici senza accesso a fatti verificati in tempo reale", isError: false, feedback: "Corretto — questa è una delle spiegazioni principali delle allucinazioni: il modello predice token plausibili senza consultare fonti esterne." },
      ],
    },
