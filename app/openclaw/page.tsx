...
const agents = [
  ...
  },
  {
    ...
    name: 'Quizard 🎯',
    role: 'Creatore Quiz',
    description: 'Gestisce Wayground end-to-end: crea quiz, configura modalità (Mastering, Practice, Exam), gestisce sezioni, punteggi e flussi di apprendimento per ogni corso.',
    tool: 'Wayground',
    output: 'Esperienze di apprendimento interattive — quiz, sessioni guidate, tracciamento progressi',
